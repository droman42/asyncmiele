...
async def test_dop2_read_leaf_builds_correct_path(client):
    client._get_raw = AsyncMock(return_value=b"\x00\x01")

    await client.dop2_read_leaf("0001", 2, 105, idx1=5, idx2=0)

    expected = "/Devices/0001/DOP2/2/105?idx1=5&idx2=0"
    client._get_raw.assert_awaited_once_with(expected)
...
async def test_dop2_write_leaf_builds_correct_path(client):
    ...
    await client.dop2_write_leaf("0001", 2, 105, payload, idx1=1, idx2=2)
